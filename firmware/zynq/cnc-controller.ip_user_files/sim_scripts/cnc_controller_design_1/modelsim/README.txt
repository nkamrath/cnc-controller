...
#
# Generated by export_simulation on Thu Sep 21 16:14:02 -0700 2017
#
################################################################################
...
switch to the './cnc_controller_design_1.sh' script.

./cnc_controller_design_1.sh -reset_run
...
./cnc_controller_design_1.sh -noclean_files

For more information on the script, please type './cnc_controller_design_1.sh -help'.
