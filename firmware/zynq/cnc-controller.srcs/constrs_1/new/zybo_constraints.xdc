...
create_clock -add -name CLK_100 -period 8.00 -waveform {0 4} [get_ports CLK_100]
...
##IO_L4N_T0_35
set_property PACKAGE_PIN D20 [get_ports {hdmi_tx_n[0]}]
set_property IOSTANDARD TMDS_33 [get_ports {hdmi_tx_n[0]}]

##IO_L4P_T0_35
set_property PACKAGE_PIN D19 [get_ports {hdmi_tx_p[0]}]
set_property IOSTANDARD TMDS_33 [get_ports {hdmi_tx_p[0]}]

##IO_L1N_T0_AD0N_35
set_property PACKAGE_PIN B20 [get_ports {hdmi_tx_n[1]}]
set_property IOSTANDARD TMDS_33 [get_ports {hdmi_tx_n[1]}]

##IO_L1P_T0_AD0P_35
set_property PACKAGE_PIN C20 [get_ports {hdmi_tx_p[1]}]
set_property IOSTANDARD TMDS_33 [get_ports {hdmi_tx_p[1]}]

##IO_L2N_T0_AD8N_35
set_property PACKAGE_PIN A20 [get_ports {hdmi_tx_n[2]}]
set_property IOSTANDARD TMDS_33 [get_ports {hdmi_tx_n[2]}]

##IO_L2P_T0_AD8P_35
set_property PACKAGE_PIN B19 [get_ports {hdmi_tx_p[2]}]
set_property IOSTANDARD TMDS_33 [get_ports {hdmi_tx_p[2]}]

##IO_L5N_T0_AD9N_35
set_property PACKAGE_PIN E19 [get_ports hdmi_tx_cec]
set_property IOSTANDARD LVCMOS33 [get_ports hdmi_tx_cec]

##IO_L5P_T0_AD9P_35
set_property PACKAGE_PIN E18 [get_ports hdmi_tx_hpd]
...
##IO_L16P_T2_35
set_property PACKAGE_PIN G17 [get_ports hdmi_tx_rscl]
set_property IOSTANDARD LVCMOS33 [get_ports hdmi_tx_rscl]

##IO_L16N_T2_35
set_property PACKAGE_PIN G18 [get_ports hdmi_tx_rsda]
...
##Pmod Header JB
##IO_L15N_T2_DQS_34
set_property PACKAGE_PIN U20 [get_ports {PWM_OUT[0]}]
