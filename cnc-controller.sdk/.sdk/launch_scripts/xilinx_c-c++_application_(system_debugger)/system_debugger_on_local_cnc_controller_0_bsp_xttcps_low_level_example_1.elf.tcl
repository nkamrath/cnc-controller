...
rst -processor
targets -set -nocase -filter {name =~ "ARM*#0" && jtag_cable_name =~ "Digilent Zybo 210279655606A"} -index 0
dow D:/Nate/dev/FPGA_stuff/fpgaProjects/zybo/cnc-controller/cnc-controller.sdk/cnc_controller_0_bsp_xttcps_low_level_example_1/Debug/cnc_controller_0_bsp_xttcps_low_level_example_1.elf
bpadd -addr &main
